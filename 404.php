...
<head>
    ...
    <link rel="stylesheet" href="<?php $this->options->themeUrl('static/404/normalize.min.css') ?>">
    <link rel="stylesheet" href="<?php $this->options->themeUrl('static/plugin/bootstrap/css/bootstrap.css') ?>">
    <link rel="stylesheet" href="<?php $this->options->themeUrl('static/404/style.css') ?>">
</head>
<body>
<main>
    <div class="container">
...
<!-- partial -->
<script src="<?php $this->options->themeUrl('static/404/gsap.min.js') ?>"></script>
<script src="<?php $this->options->themeUrl('static/404/script.js') ?>"></script>
